...
const WeatherScreenBottom = ({ city }) => {
  ...
  useEffect(() => {
    ...
    fetchHourlyForecast(city); // Use the city parameter from props
    fetchWeeklyWeatherData(city); // Use the city parameter from props
  }, [city]);
